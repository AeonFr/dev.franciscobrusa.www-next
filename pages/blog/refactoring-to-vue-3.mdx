export const metadata = { title: "Refactoring to Vue 3", socialImage: "/blog/refactoring-to-vue-3/social-image.png", description: "Using the composition API to express reusable stateful logic in VueJS" };
